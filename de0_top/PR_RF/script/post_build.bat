...
..\..\utils\fpga_post_ver.exe .\output_files\de0_fpga_checksum.txt .\output_files\de0_fpga_crc32.txt .\output_files\de0_fpga_md5.txt .\output_files\fpga_build.h .\output_files\fpga_version.h
